               ...
               // Toast.makeText(SettingsActivity.this,dataSnapshot.toString(),Toast.LENGTH_LONG).show();
                ...
                if(!image.equals("default")){
                   // Picasso.with(SettingsActivity.this).load(image).placeholder(R.mipmap.default_avatar).into(mDisplayImage);
                    Picasso.with(SettingsActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.mipmap.default_avatar)
...
//                            });}
                            ...
                            Toast.makeText(SettingsActivity.this,"Error in uploading DP.",Toast.LENGTH_LONG).show();
                            mProgressDialog.dismiss();
                        }
//                    }
//                });
