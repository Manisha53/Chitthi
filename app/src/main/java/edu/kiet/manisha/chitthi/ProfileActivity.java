...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mProfileFriendsCount = (TextView) findViewById(R.id.profile_totalFriends);
        ...
        mDeclineBtn = (Button) findViewById(R.id.profle_decline_btn);
            ...
            public void onClick(View view) {
                ...
                mDeclineBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        valueMap.put("Friend_req/" + mCurrent_user.getUid() + "/" + user_id , null);
                        valueMap.put("Friend_req/" + user_id + "/" + mCurrent_user.getUid() , null);

                        mRootRef.updateChildren(valueMap , new DatabaseReference.CompletionListener() {
